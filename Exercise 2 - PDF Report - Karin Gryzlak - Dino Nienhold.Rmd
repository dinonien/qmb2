...
##Task 3
In this task we conduct chi-square test of indepedence to test if the variable rooms is indepent from the variable nr.
...
Therefore we reject the $\sf{H_{0}}$ and there is a strong evidence that the variables are not independent.
